      ...
      <div class="bg-white rounded-2xl shadow-xl w-full max-w-5xl max-h-[92vh] overflow-y-auto">
        <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100 sticky top-0 bg-white">
          ...
          <div class="flex items-center gap-3">
            <button data-drivefac="${x.id}" class="text-sm font-medium text-emerald-700 hover:text-emerald-900 flex items-center gap-1" title="Ouvrir CETTE facture dans Google Drive">📁 Voir dans le Drive</button>
