...
PNG.store = (function () {
  ...
  function creerDepuisOCR(champs, opts) {
    ...
    const fac = {
      ...
      dateDepot: U.todayISO(), dateImport: U.todayISO(), statut: "a_valider",
      dateReglement: null, dateDecaissement: null, regleParSocieteId: null,
      fournisseur, categorie: champs.categorie || fref.categorie || "Divers",
      ...
      compteCharge: champs.compteCharge || fref.compteCharge || "606800", compteTva: "445660",
      compteParIA: !!champs.compteParIA,
